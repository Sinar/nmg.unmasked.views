...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_nmg_person_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='nmg-person-view'
        )
        self.assertTrue(view.__name__ == 'nmg-person-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in nmg-person-view'
        # )

    def test_nmg_person_view_not_matching_interface(self):
