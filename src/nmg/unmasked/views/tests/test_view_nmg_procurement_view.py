...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_nmg_procurement_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='nmg-procurement-view'
        )
        self.assertTrue(view.__name__ == 'nmg-procurement-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in nmg-procurement-view'
        # )

    def test_nmg_procurement_view_not_matching_interface(self):
