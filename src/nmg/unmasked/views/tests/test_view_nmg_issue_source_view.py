...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_nmg_issue_source_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='nmg-issue-source-view'
        )
        self.assertTrue(view.__name__ == 'nmg-issue-source-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in nmg-issue-source-view'
        # )

    def test_nmg_issue_source_view_not_matching_interface(self):
