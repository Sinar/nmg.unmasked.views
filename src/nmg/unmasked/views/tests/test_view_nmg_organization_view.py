...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_nmg_organization_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='nmg-organization-view'
        )
        self.assertTrue(view.__name__ == 'nmg-organization-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in nmg-organization-view'
        # )

    def test_nmg_organization_view_not_matching_interface(self):
