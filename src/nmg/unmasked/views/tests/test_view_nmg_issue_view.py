...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_nmg_issue_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='nmg-issue-view'
        )
        self.assertTrue(view.__name__ == 'nmg-issue-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in nmg-issue-view'
        # )

    def test_nmg_issue_view_not_matching_interface(self):
